package com.example.ui201849057liujiujiang.lib;
...
public class ShareToolUtil {
    ...
    public static final String AUTHORITY = "com.example.liujiujiang.fileprovider";
    ...
    public static void getPermission(Context context) {
        ...
        boolean permission = PackageManager.PERMISSION_GRANTED  == packageManager.checkPermission("android.permission.WRITE_EXTERNAL_STORAGE","com.example.liujiujiang");
        if (permission) {
            // 有这个权限
        }else{
            // 没有这个权限
        ...
        permission = PackageManager.PERMISSION_GRANTED  == packageManager.checkPermission("android.permission.READ_EXTERNAL_STORAGE","com.example.liujiujiang");
        if (permission) {
            // 有这个权限
        }else{
            // 没有这个权限
