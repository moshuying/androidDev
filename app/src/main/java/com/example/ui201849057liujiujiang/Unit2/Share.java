...
import com.example.ui201849057liujiujiang.lib.NativeShareTool;
import com.example.ui201849057liujiujiang.lib.QQUtil;
import com.example.ui201849057liujiujiang.lib.Resource;
import com.example.ui201849057liujiujiang.lib.ShareToolUtil;
        ...
        myAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                switch (dates.get(position)) {
                    case "微信好友-文本":
                        nativeShareTool.shareWechatFriend("测试信息，记得常去访问 www.liujiujiang.top 哦~·");
                        break;
                    case "微信好友-图片":
                    ...
                    case "微信朋友圈-单图":
                        ...
                        break;
                    case "QQ好友-文本":
                        nativeShareTool.shareQQ("测试信息，记得常去访问liujiujiang.top哦~·");
                        break;
                    case "QQ好友-图片":
